...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-boxed">
        ...
        <div class="page-header">
            ...
            <div class="page-header-top">
                <div class="container">
                    ...
                    <div class="page-logo">
                        <a href="index.html">
                            <img src="{{asset('layouts/layout3/img/logo-default.jpg')}}" alt="logo" class="logo-default">
                        </a>
                    </div>
                    <!-- END LOGO -->
                                ...
                                <ul class="dropdown-menu pull-left">
                                    ...
                                    <li class="dropdown-submenu ">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="dropdown-submenu ">
                                                <a href="javascript:;" class="nav-link nav-toggle"> Miscellaneous
                                                    <span class="arrow"></span>
                                                </a>
                                                <ul class="dropdown-menu">
                                                    <li class="">
        ...
        <div class="page-footer">
            <div class="container"> 2018 Ministerio de Planificacion del Desarrollo
